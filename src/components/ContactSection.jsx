          ...
          <div className="space-y-6 sm:space-y-8 p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-secondary/20 to-background border border-border">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div className="flex flex-col">
                  <p className="text-xs text-start sm:text-sm text-muted-foreground">Email</p>
                  <a
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  <p className="text-xs text-start sm:text-sm text-muted-foreground">Phone</p>
                  <a
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  <p className="text-xs text-start sm:text-sm text-muted-foreground">Location</p>
            ...
            <div className="pt-6 sm:pt-8">
              ...
              <div className="flex gap-2 justify-center sm:gap-3">
                {socialLinks.filter(s => s.label !== 'Email' && s.label !== 'YouTube').map((social, index) => (
                  <a
                    key={index}
                    href={social.url}
                    target="_blank"
