...
export const Footer = () => {
  ...
  const contactInfo = [
    ...
    { icon: <Phone size={16} />, text: personalInfo.phone, href: `tel:${personalInfo.phone.replace(/\\s+/g, '')}` },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">ED-Deryouch</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Digital designer & developer creating meaningful experiences.
              </p>
              <div className="flex space-x-4">
                {socialLinks.filter(s => s.label !== 'Email').map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.url}
                    target="_blank"
